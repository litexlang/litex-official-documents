...
3. Start using Litex in your daily work: install and run Litex locally on your computer for immediate productivity gains in mathematical reasoning, formal proof verification, and academic research. Get started [here](https://litexlang.com/doc/Start)
